            ...
            <div class="col-xl-4 proorder-xxl-1 col-sm-6 box-col-6">
                <div class="card welcome-banner">
                    <div class="card-header p-0 card-no-border">
                        <div class="welcome-card"><img class="w-100 img-fluid" src="{{asset('assets/images/dashboard-1/welcome-bg.png')}}" alt=""/><img class="position-absolute img-1 img-fluid" src="{{asset('assets/images/dashboard-1/img-1.png')}}" alt=""/><img class="position-absolute img-2 img-fluid" src="{{asset('assets/images/dashboard-1/img-2.png')}}" alt=""/><img class="position-absolute img-3 img-fluid" src="{{asset('assets/images/dashboard-1/img-3.png')}}" alt=""/><img class="position-absolute img-4 img-fluid" src="{{asset('assets/images/dashboard-1/img-4.png')}}" alt=""/><img class="position-absolute img-5 img-fluid" src="{{asset('assets/images/dashboard-1/img-5.png')}}" alt=""/></div>
                    </div>
                    <div class="card-body">
                        <div class="d-flex align-center">
                            <h1>Hello, Amirreza  <img src="{{asset('assets/images/dashboard-1/hand.png')}}" alt=""/></h1>
                        </div>
                        ...
                        <div class="table-responsive theme-scrollbar">
                            <table class="table display" style="width:100%">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center gap-2">
                                            <div class="flex-shrink-0"><img src="{{asset('assets/images/dashboard-1/user/1.png')}}" alt=""/></div>
                                            <div class="flex-grow-1">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center gap-2">
                                            <div class="flex-shrink-0"><img src="{{asset('assets/images/dashboard-1/user/2.png')}}" alt=""/></div>
                                            <div class="flex-grow-1">
                                                <h6>Naomi watson</h6>
                                            </div>
                                        </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center gap-2">
                                            <div class="flex-shrink-0"><img src="{{asset('assets/images/dashboard-1/user/3.png')}}" alt=""/></div>
                                            <div class="flex-grow-1">
                                                <h6>Dann Petty</h6>
                                            </div>
                                        </div>
                        ...
                        <div class="table-responsive theme-scrollbar">
                            <table class="table display table-bordernone" id="transaction" style="width:100%">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center gap-3">
                                            <div class="flex-shrink-0"><img src="{{asset('assets/images/dashboard-1/icon/1.png')}}" alt=""/></div>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center gap-3">
                                            <div class="flex-shrink-0"><img src="{{asset('assets/images/dashboard-1/icon/2.png')}}" alt=""/></div>
                                            <div class="flex-grow-1"><a href="product-page.html">
                                                    <h6>Spring Bed</h6></a>
                                                <p>Bought item</p>
                                            </div>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center gap-3">
                                            <div class="flex-shrink-0"><img src="{{asset('assets/images/dashboard-1/icon/3.png')}}" alt=""/></div>
                                            <div class="flex-grow-1"><a href="product-page.html">
                                                    <h6>Long Dress</h6></a>
                                                <p>Bought item</p>
                                            </div>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center gap-3">
                                            <div class="flex-shrink-0"><img src="{{asset('assets/images/dashboard-1/icon/4.png')}}" alt=""/></div>
                                            <div class="flex-grow-1"><a href="product-page.html">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center gap-3">
                                            <div class="flex-shrink-0"><img src="{{asset('assets/images/dashboard-1/icon/5.png')}}" alt=""/></div>
                                            <div class="flex-grow-1"><a href="product-page.html">
                                                    <h6>Sofa Hauga</h6></a>
                                                <p>Item Sold</p>
                                            </div>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center gap-3">
                                            <div class="flex-shrink-0"><img src="{{asset('assets/images/dashboard-1/icon/6.png')}}" alt=""/></div>
                                            <div class="flex-grow-1"><a href="product-page.html">
                    ...
                    <div class="card-body audit-log">
                        <ul>
                            <li class="d-flex align-items-center gap-2">
                                <div class="flex-shrink-0 bg-success"><img src="{{asset('assets/images/dashboard-1/icon/checked.png')}}" alt=""/></div>
                                <div class="flex-grow-1"><a href="product-page.html">
                            ...
                            <li class="d-flex align-items-center gap-2">
                                <div class="flex-shrink-0 bg-warning"><img src="{{asset('assets/images/dashboard-1/icon/danger.png')}}" alt=""/></div>
                                <div class="flex-grow-1"><a href="product-page.html">
                            ...
                            <li class="d-flex align-items-center gap-2">
                                <div class="flex-shrink-0 bg-danger"><img src="{{asset('assets/images/dashboard-1/icon/cancel.png')}}" alt=""/></div>
                                <div class="flex-grow-1"><a href="product-page.html">
                    ...
                    <div class="card-body top-user pt-2">
                        <ul>
                            <li class="d-flex align-items-center justify-content-between gap-2">
                                <div class="d-flex gap-2">
                                    <div class="flex-shrink-0 comman-round"><img src="{{asset('assets/images/dashboard-1/user/01.png')}}" alt=""/></div>
                                    <div><a href="#">
                            ...
                            <li class="d-flex align-items-center justify-content-between gap-2">
                                <div class="d-flex gap-2">
                                    <div class="flex-shrink-0 comman-round"><img src="{{asset('assets/images/dashboard-1/user/02.png')}}" alt=""/></div>
                                    <div><a href="#">
                            ...
                            <li class="d-flex align-items-center justify-content-between gap-2">
                                <div class="d-flex gap-2">
                                    <div class="flex-shrink-0 comman-round"><img src="{{asset('assets/images/dashboard-1/user/03.png')}}" alt=""/></div>
                                    <div><a href="#">
                            ...
                            <li class="d-flex align-items-center justify-content-between gap-2">
                                <div class="d-flex gap-2">
                                    <div class="flex-shrink-0 comman-round"><img src="{{asset('assets/images/dashboard-1/user/04.png')}}" alt=""/></div>
                                    <div><a href="#">
                                            <h6>Brown Acum</h6></a>
                                        <p>
                                            <svg class="stroke-icon">
                            ...
                            <li class="d-flex align-items-center justify-content-between gap-2">
                                <div class="d-flex gap-2">
                                    <div class="flex-shrink-0 comman-round"><img src="{{asset('assets/images/dashboard-1/user/05.png')}}" alt=""/></div>
                                    <div><a href="#">
                                            <h6>Evans Mayo</h6></a>
                                        <p>
                                            <svg class="stroke-icon">
                            ...
                            <li class="d-flex align-items-center justify-content-between gap-2">
                                <div class="d-flex gap-2">
                                    <div class="flex-shrink-0 comman-round"><img src="{{asset('assets/images/dashboard-1/user/06.png')}}" alt=""/></div>
                                    <div><a href="#">
                            ...
                            <li class="d-flex align-items-center justify-content-between gap-2">
                                <div class="d-flex gap-2">
                                    <div class="flex-shrink-0 comman-round"><img src="{{asset('assets/images/dashboard-1/user/07.png')}}" alt=""/></div>
                                    <div><a href="#">
                    ...
                    <div class="card-body news-update">
                        <ul>
                            <li class="d-flex gap-2">
                                <div class="flex-shrink-0"><img class="img-fluid" src="{{asset('assets/images/dashboard-1/news-update/1.png')}}" alt=""/></div>
                            ...
                            <li class="d-flex gap-2">
                                <div class="flex-shrink-0"><img class="img-fluid" src="{{asset('assets/images/dashboard-1/news-update/2.png')}}" alt=""/></div>
                                <div class="flex-grow-1"> <a href="private-chat.html">
                            ...
                            <li class="d-flex gap-2">
                                <div class="flex-shrink-0"><img class="img-fluid" src="{{asset('assets/images/dashboard-1/news-update/3.png')}}" alt=""/></div>
                                <div class="flex-grow-1"> <a href="private-chat.html">
                            ...
                            <li class="d-flex gap-2">
                                <div class="flex-shrink-0"><img class="img-fluid" src="{{asset('assets/images/dashboard-1/news-update/4.png')}}" alt=""/></div>
                                <div class="flex-grow-1"> <a href="private-chat.html">
                            ...
                            <li class="d-flex gap-2">
                                <div class="flex-shrink-0"><img class="img-fluid" src="{{asset('assets/images/dashboard-1/news-update/5.png')}}" alt=""/></div>
                                <div class="flex-grow-1"> <a href="private-chat.html">
                                        <h6>Business project research</h6></a>
                            ...
                            <li class="d-flex gap-2">
                                <div class="flex-shrink-0"><img class="img-fluid" src="{{asset('assets/images/dashboard-1/news-update/6.png')}}" alt=""/></div>
                                <div class="flex-grow-1"> <a href="private-chat.html">
                            ...
                            <li class="d-flex gap-2">
                                <div class="flex-shrink-0"><img class="img-fluid" src="{{asset('assets/images/dashboard-1/news-update/7.png')}}" alt=""/></div>
                                <div class="flex-grow-1"> <a href="private-chat.html">
                                        <h6>Added new work</h6></a>
                                    <p class="text-truncate">Today’s news headlines,Breaking...</p>
